...
void DrawStick() {
    esat::DrawLine(esat::MousePositionX(), esat::MousePositionY(), esat::MousePositionX() + 100, esat::MousePositionY() + 200);
}
...
esat::Vec2 FixEq2x2(esat::Vec2 first, esat::Vec2 second) {

    esat::Vec2 result;

    result.x = first.x - first.y;
    result.y = first.y - first.x;
}
