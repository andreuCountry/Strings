...
cl /nologo /Zi /GR- /EHs /MD "%2" -I "%~dp0Lib_Graph\ESAT_rev248\include" "%~dp0Lib_Graph\ESAT_rev248\bin\ESAT.lib" opengl32.lib user32.lib gdi32.lib shell32.lib Ws2_32.lib
